...
function Navlist() {
    ...
    return (
        <div className="list-group list-group-flush">
            ...
            <Link to={"/settings/" + user.email + ',' + user.id} className="list-group-item list-group-item-action bg-dark"><img id="white-3" src={gear} alt="avatar" /> <img id="colored-icon-3" src={gear_color} alt="settings" /> Settings</Link>
